...
from benchmarks.concurrency.telemetry.analysis import parse_perf_stat
from benchmarks.concurrency.telemetry.support import (
...
def child_command(
    ...
    *,
    ...
    command = [
        sys.executable,
        "-m",
        "benchmarks.concurrency.telemetry.cli",
        "--fixture",
        str(args.fixture),
        "--rows",
        str(args.rows),
