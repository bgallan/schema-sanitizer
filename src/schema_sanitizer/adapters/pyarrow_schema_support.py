"""Shared schema-support cache helpers for PyArrow adapter fast paths."""
...
class SchemaSupportCache:
    """Small bounded cache for adapter schema support decisions."""

    def __init__(self, *, max_size: int = 128) -> None:
        """Create an empty bounded schema support cache."""
        self._max_size = max_size
        self._by_object_id: dict[int, bool] = {}
    ...
    def get_by_object(self, schema: Any) -> bool | None:
        ...
        return self._by_object_id.get(id(schema))
    ...
    def set_fingerprint(self, schema: Any, fingerprint: bytes, supported: bool) -> bool:
        """Store one fingerprint support decision and return it."""
    ...
    def set(self, schema: Any, supported: bool, *, include_text: bool) -> bool:
        """Store one support decision and return it."""
        self._record_object(schema, supported)
        if include_text:
    ...
    def _record_text(self, key: str, supported: bool) -> None:
        """Store one schema-text support decision."""
