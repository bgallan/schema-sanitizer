...
The project requires CPython 3.11 or newer, a C++23 compiler, CMake, and a build
backend supported by scikit-build-core. Ninja is recommended for local native
work.
...
- [Reader security limits](reader-security-limits.md);
- [Reader memory accounting](reader-memory-accounting.md);
