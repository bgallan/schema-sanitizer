...
| [`native/`](native/) | Native source, toolchain, and binary linkage policy | Windows compiler certification, `check_no_arrow_cpp.sh`, `check_no_libarrow_linkage.sh`, the manual CMake documentation target |
