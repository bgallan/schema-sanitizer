...
PARQUET_CONTRACT_RUNTIME_TEST_GROUPS: dict[str, tuple[str, ...]] = {
    "schema_sanitizer_native_reader": (
        "tests/parquet/test_parquet_native_scalar_paths_and_staging.py::test_native_parquet_stream_materializes_plain_fixed_width_rows",
        "tests/parquet/test_parquet_native_scalar_projection_and_encodings.py::test_native_parquet_stream_materializes_plain_boolean_rows",
    ),
    ...
    "nested_projection_contracts": (
        "tests/parquet/test_parquet_native_recursive_projection_permutations.py::test_native_parquet_stream_preserves_recursive_root_fingerprints_under_projection_permutations",
    ),
}
