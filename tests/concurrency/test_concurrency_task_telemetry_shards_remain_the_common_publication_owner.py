"""Regression coverage for concurrency task telemetry shards remain the common publication owner."""
...
def test_task_telemetry_shards_remain_the_common_publication_owner() -> None:
    """The task-telemetry-shards-remain-the-common-publication shards remain authoritative after later worker-range widening."""
...
def test_telemetry_json_aggregates_global_and_worker_shards() -> None:
...
def test_public_four_worker_path_publishes_exact_sharded_stats(
    tmp_path: Path,
) -> None:
