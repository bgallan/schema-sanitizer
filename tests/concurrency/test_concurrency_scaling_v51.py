"""Regression coverage for v51's fully budgeted high-core dispatch window."""
...
def test_v51_high_core_cross_batch_prefetch_uses_the_budgeted_window() -> None:
...
def test_v51_dispatch_source_has_one_canonical_owner() -> None:
...
def test_v51_low_and_high_core_ordered_results_remain_identical() -> None:
...
def test_v51_high_core_output_priority_still_drains_exactly() -> None:
    """A wider producer window must not weaken dedicated-output preference."""
    require_native()
