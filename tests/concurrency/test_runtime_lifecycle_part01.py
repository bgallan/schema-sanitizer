...
# Split from test_runtime_lifecycle.py: test_opened_registry_stream_materialization_uses_raw_arrow_stream, test_opened_registry_stream_materialization_closes_raw_stream, test_opened_registry_file_output_uses_raw_stream, ...
