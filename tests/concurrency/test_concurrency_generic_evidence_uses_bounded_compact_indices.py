...
def test_generic_evidence_uses_bounded_compact_indices() -> None:
...
def test_stats_validation_is_adaptive_and_compile_time_specialized() -> None:
...
def test_nested_inference_preserves_single_multi_semantics() -> None:
        ...
        rows.append(
            {
                ...
                "padding": "generic-evidence-uses-bounded-compact-indices-compact-evidence" * 3,
            }
        )
