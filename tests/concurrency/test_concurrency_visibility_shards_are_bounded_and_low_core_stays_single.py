...
EVIDENCE = ROOT / "benchmarks/evidence/concurrency/scheduler/sharded-queue-visibility.json"
...
def test_real_arena_probe_exercises_disjoint_visibility_domains() -> None:
    ...
    source = (
        ROOT / "benchmarks/probes/concurrency/scheduler/sharded-queue-visibility-tsan.cc"
