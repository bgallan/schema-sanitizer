"""Regression coverage for v52 zero-copy shared RowRef packet ranges."""
...
def test_v52_sources_use_one_shared_batch_and_disjoint_row_spans() -> None:
...
def test_v52_zero_copy_packets_preserve_single_oracle(tmp_path: Path) -> None:
