...
def test_every_format_has_parallel_work_and_documented_boundaries() -> None:
...
def test_coverage_matrix_declares_real_json_and_pandas_parallel_stages() -> None:
    """Coverage names the worker-owned work added by every-format-has-parallel-work-and-documented."""
...
def test_flat_json_arrays_use_adaptive_columnar_packets() -> None:
...
def test_pandas_adapter_obeys_single_multi_threading_policy(
...
def test_all_public_outputs_keep_multi_threading() -> None:
