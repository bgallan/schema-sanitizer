...
from benchmarks.concurrency.telemetry.high_core_evidence import (
    _resume_profile,
    _write_profile_meta,
)
from benchmarks.concurrency.telemetry.high_core_suite import recommend_suite_frontier
...
def test_high_core_suite_plan_locks_one_affinity_for_both_profiles(
    ...
    completed = subprocess.run(
        [
            sys.executable,
            "-m",
            "benchmarks.concurrency.telemetry.high_core_evidence",
            "--workers",
            "1,2",
            "--short-rows",
            "100",
