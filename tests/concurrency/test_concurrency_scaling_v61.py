"""Regression coverage for v61 run-based JSON string escaping."""
...
def test_v61_string_runs_preserve_exact_single_multi_json_escaping(
    tmp_path: Path,
) -> None:
...
def test_v61_token_writer_appends_safe_runs_instead_of_each_byte() -> None:
