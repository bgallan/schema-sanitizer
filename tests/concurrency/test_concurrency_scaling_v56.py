"""Regression coverage for v56 compact scalar-category dispatch."""
...
def test_v56_wide_mixed_scalar_inference_matches_single() -> None:
...
def test_v56_nested_and_empty_container_fallback_matches_single() -> None:
...
def test_v56_scalar_dispatch_is_single_tag_switch() -> None:
