"""Regression coverage for v39 adaptive JSONL row parallelism."""
...
def _consume(source: Path, output: Path, *, mode: str, contract: object):
    ...
    result = write_raw_stream_to_file(
        ...
        feature="v39 adaptive JSONL row parallelism",
...
def test_v39_sources_define_bounded_hybrid_row_mode() -> None:
