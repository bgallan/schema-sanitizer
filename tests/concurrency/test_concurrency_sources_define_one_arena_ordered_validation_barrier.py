"""Regression coverage for concurrency sources define one arena ordered validation barrier."""
...
def _consume(source: Path, output: Path, *, mode: str, contract: object):
    ...
    result = write_raw_stream_to_file(
        ...
        feature="sources-define-one-arena-ordered-validation-barrier parallel JSON validation",
