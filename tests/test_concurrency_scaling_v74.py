"""Regression coverage for v74 adaptive CSV record framing."""
...
def test_v74_csv_coverage_names_the_adaptive_framing_stage() -> None:
...
def test_v74_csv_scanner_is_adaptive_without_private_threads() -> None:
...
def test_v74_csv_chunk_boundaries_preserve_exact_single_multi_values(
    tmp_path: Path,
) -> None:
...
def test_v74_wide_csv_keeps_parallel_decode_and_exact_probe_parity(
    tmp_path: Path,
) -> None:
