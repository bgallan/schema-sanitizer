...
# Split from test_parquet_pipeline_fallbacks.py: test_parquet_stream_factory_observability_counts_are_defensive, test_parquet_fallback_observability_counts_attempts_successes_and_failures, test_native_parquet_stream_marks_schema_sanitizer_writer_contract, ...
