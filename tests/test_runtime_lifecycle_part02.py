...
# Split from test_runtime_lifecycle.py: test_registry_probe_path_sources_native_state_round_trip, test_registry_probe_path_source_chunk_provider_native_round_trip, test_registry_sink_path_source_chunk_provider_auto_registry_native_round_trip, ...
