...
# Split from test_parquet_contract_gates.py: test_native_nested_contract_status_certifies_stable_recursive_summary, test_native_nested_contract_status_fails_closed_on_recursive_drift, test_native_parquet_nested_contract_status_uses_public_summary, ...
