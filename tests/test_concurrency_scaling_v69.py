"""Regression coverage for v69 compact packet-local inference keys."""
...
def test_v69_repeated_nested_keys_preserve_single_multi_inference() -> None:
...
def test_v69_high_cardinality_keys_preserve_single_multi_inference() -> None:
