"""Pass65 adversarial linearization and external-runtime ownership regressions."""
...
def test_external_thread_borrow_linearizes_with_parent_release(
    ...
    governor = module._Governor(4, "pass65_atomic_borrow")
...
def test_parent_shrink_cannot_invalidate_live_external_borrow(
    ...
    governor = module._Governor(5, "pass65_shrink")
...
def test_fd_opening_state_prevents_credit_release_before_opener_returns(tmp_path: Path) -> None:
    ...
    capability = module.FileDescriptorCapability(Lease(), 1, label="pass65-opening")
    path = tmp_path / "x"
...
def test_external_runtime_shrinks_logical_and_native_envelope_to_real_pool(
    ...
    governor = module._Governor(8, "pass65_pool_width")
