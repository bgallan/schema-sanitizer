...
def test_buffered_generated_bytes_close_is_allocation_free() -> None:
    ...
    source = package_source_text("core_impl/generated_bytes.py")
    discard = source[
...
def test_sync_transports_reserve_cleanup_before_resource_construction() -> None:
    ...
    azure = package_source_text("remote_impl/providers/azure_sync.py")
    s3 = package_source_text("remote_impl/providers/s3_sync.py")
    http = package_source_text("remote_impl/sync_http.py")
...
def test_remote_sync_and_async_share_authoritative_waiter_queue() -> None:
    ...
    source = package_source_text("remote_impl/io_permits.py")
    sync = source[
...
def test_fd_capacity_distinguishes_reserved_from_physically_open() -> None:
    ...
    py = package_source_text("core_impl/process_resources.py")
    native = cpp_source_text("internal/runtime/operation_task_arena.cc")
...
def test_native_fd_governor_waits_is_fork_safe_and_shutdown_visible() -> None:
    ...
    shutdown = package_source_text("core_impl/runtime_shutdown.py")
    diagnostics = package_source_text("core_impl/runtime_diagnostics.py")
...
def test_remote_footprint_underdeclaration_fails_before_recursive_fd_wait() -> None:
    ...
    source = package_source_text("remote_impl/io_footprint.py")
...
def test_coordination_and_atomic_control_fds_use_teardown_authority() -> None:
    ...
    journal = package_source_text("core_impl/coordination_journal.py")
    atomic = package_source_text("core_impl/atomic_output.py")
