"""Regression coverage for v71 end-to-end format concurrency."""
...
def test_v71_coverage_matrix_matches_every_public_format() -> None:
...
def test_v71_frontends_receive_the_shared_operation_arena() -> None:
...
def test_v71_every_native_input_and_output_has_a_parallel_route() -> None:
...
def test_v71_csv_rows_decode_in_parallel_with_exact_parity(tmp_path: Path) -> None:
...
def test_v71_xml_rows_decode_in_parallel_with_exact_parity(tmp_path: Path) -> None:
...
def test_v71_small_xml_keeps_the_overhead_avoiding_fallback(tmp_path: Path) -> None:
...
def test_v71_output_coverage_is_explicit(output_name: str, expected_stage: str) -> None:
