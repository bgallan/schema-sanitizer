...
def test_parquet_contract_runtime_suite_selects_no_skip_runtime_contract_tests() -> None:
    ...
    assert all(test.startswith("tests/test_parquet_") and "::test_" in test for test in selected)
...
def test_parquet_contract_runtime_suite_plugin_detects_selected_skips() -> None:
    ...
    plugin.pytest_runtest_logreport(
        SimpleNamespace(
            nodeid="tests/test_parquet_native_scalar_runtime_part01.py::test_runtime",
            outcome="skipped",
            skipped=True,
            when="setup",
    ...
    plugin.pytest_runtest_logreport(
        SimpleNamespace(
            nodeid="tests/test_parquet_native_scalar_runtime_part01.py::test_other",
            outcome="passed",
            skipped=False,
            when="call",
            longrepr=None,
...
def test_parquet_contract_runtime_suite_selection_detects_missing_group() -> None:
    ...
    status = _validate_runtime_suite_selection(
        groups={
            "safe_pyarrow_fallback": (
                "tests/test_parquet_native_scalar_runtime_part01.py::test_spark_flavored_nested_parquet_uses_pyarrow_fallback",
            )
        },
...
def test_parquet_contract_runtime_suite_selection_detects_stale_nodeid() -> None:
    ...
    status = _validate_runtime_suite_selection(
        groups={
            "safe_pyarrow_fallback": (
                "tests/test_parquet_native_scalar_runtime_part01.py::test_this_runtime_contract_test_no_longer_exists",
            )
        },
...
def test_parquet_contract_runtime_suite_group_execution_summary_accepts_group_passes() -> None:
    ...
    groups = {
        "safe_pyarrow_fallback": [
            "tests/test_parquet_native_scalar_runtime_part01.py::test_fallback"
        ],
        "nested_projection_contracts": [
            "tests/test_parquet_native_scalar_runtime_part01.py::test_projection"
        ],
    }
    reports = [
        {
            "nodeid": "tests/test_parquet_native_scalar_runtime_part01.py::test_fallback",
            "outcome": "passed",
        },
        {
            "nodeid": "tests/test_parquet_native_scalar_runtime_part01.py::test_projection",
            "outcome": "passed",
        },
    ]
...
def test_parquet_contract_runtime_suite_group_execution_summary_detects_missing_group_pass() -> (
    ...
    groups = {
        "schema_sanitizer_native_reader": [
            "tests/test_parquet_native_scalar_runtime_part01.py::test_native"
        ],
        "nested_recursive_grammar": [
            "tests/test_parquet_native_scalar_runtime_part01.py::test_nested"
        ],
    }
    reports = [
        {
            "nodeid": "tests/test_parquet_native_scalar_runtime_part01.py::test_native",
            "outcome": "passed",
        },
        {
            "nodeid": "tests/test_parquet_native_scalar_runtime_part01.py::test_unselected",
            "outcome": "passed",
        },
    ]
...
def test_parquet_contract_runtime_suite_group_execution_summary_matches_parametrized_reports() -> (
    ...
    groups = {
        "nested_recursive_grammar": [
            "tests/test_parquet_native_scalar_runtime_part01.py::test_nested_fuzzer"
        ],
    }
    reports = [
        {
            "nodeid": "tests/test_parquet_native_scalar_runtime_part01.py::test_nested_fuzzer[seed-0]",
            "outcome": "passed",
        }
    ]
...
def test_parquet_contract_runtime_suite_certificate_accepts_full_contract() -> None:
    ...
    selected_by_group = {
        group: [f"tests/test_parquet_native_scalar_runtime_part01.py::test_{group}"]
...
def test_parquet_contract_runtime_suite_certificate_fails_missing_nested_group() -> None:
    ...
    selected_by_group = {
        ...
        "nested_null_empty_row_group_phases": [
            "tests/test_parquet_native_scalar_runtime_part01.py::test_phases"
        ],
        "nested_levels_repetition_topology": [
            "tests/test_parquet_native_scalar_runtime_part01.py::test_levels"
        ],
        "nested_projection_contracts": [
            "tests/test_parquet_native_scalar_runtime_part01.py::test_projection"
        ],
    ...
    reports = [
        ...
        {
            "nodeid": "tests/test_parquet_native_scalar_runtime_part01.py::test_nested",
            "outcome": "passed",
        },
        {
            "nodeid": "tests/test_parquet_native_scalar_runtime_part01.py::test_phases",
            "outcome": "passed",
        },
        {
            "nodeid": "tests/test_parquet_native_scalar_runtime_part01.py::test_levels",
            "outcome": "passed",
        },
    ]
    group_execution = _runtime_suite_group_execution_summary(
