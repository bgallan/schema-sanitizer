"""Regression coverage for v66 grouped fixed-cost Parquet input tasks."""
...
def test_v66_groups_only_sustained_fixed_cost_columns() -> None:
    """Wide fixed columns group, while variable and repeated columns retain v65."""
...
def test_v66_grouped_ranges_preserve_column_order_and_one_budget() -> None:
...
def test_v66_fixed_wide_parquet_single_and_multi_are_byte_identical(
    tmp_path: Path,
) -> None:
