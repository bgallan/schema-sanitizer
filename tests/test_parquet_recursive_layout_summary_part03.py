...
# Split from test_parquet_recursive_layout_summary.py: test_native_recursive_layout_summary_tracks_repeated_ancestor_profiles, test_native_recursive_layout_summary_detects_repeated_ancestor_level_assignment_drift, test_native_recursive_layout_summary_exposes_leaf_contracts, ...
