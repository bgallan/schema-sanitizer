"""Regression coverage for v49 high-core worker-local telemetry batching."""
...
def test_v49_high_core_executor_remains_exact_and_bounded() -> None:
...
def test_v49_high_core_batching_remains_bounded() -> None:
    """The v49 32-task batching bound survives later shard publication."""
...
def test_v49_low_and_high_core_paths_are_value_deterministic() -> None:
