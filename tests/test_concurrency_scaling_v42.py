"""Regression coverage for v42 zero-copy deferred JSONL row assembly."""
...
def _consume(source: Path, output: Path, *, mode: str, contract: object):
    ...
    result = write_raw_stream_to_file(
        ...
        feature="v42 deferred JSONL row assembly",
...
def test_v42_sources_define_direct_rows_and_lazy_segment_state() -> None:
